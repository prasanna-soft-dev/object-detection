...
import argparse
# for translation, rotation, resizing, skeletonization, displaying Matplotlib images, sorting contours, detecting edges
import imutils
import time
import cv2
...
#load our model and set up our video stream
